...
const Filters_component_1 = __importDefault(require("@/components/Filters/Filters.component"));
const Products_component_1 = __importDefault(require("@/components/Products/Products.component"));
const CartManager_reducer_1 = require("@/utils/CartManager/CartManager.reducer");
function Home() {
    const dispatch = (0, hooks_1.useAppDispatch)();
    const fetchProductsAPI = (0, react_1.useCallback)(() => {
        return new Promise((resolve, reject) => {
            dispatch({
                type: ProductsManager_reducer_1.actions.START_FETCHING_PRODUCTS,
                promise: { resolve, reject },
            });
        });
    }, [dispatch]);
    const fetchCategoriesAPI = (0, react_1.useCallback)(() => {
        return new Promise((resolve, reject) => {
            dispatch({
                type: ProductsManager_reducer_1.actions.START_FETCHING_CATEGORIES,
                promise: { resolve, reject },
            });
        });
    }, [dispatch]);
    const fetchCartAPI = (0, react_1.useCallback)(() => {
        return new Promise((resolve, reject) => {
            dispatch({
                type: CartManager_reducer_1.actions.START_FETCHING_CART,
                promise: { resolve, reject },
            });
        });
    }, [dispatch]);
    ...
    return (<main className="flex min-h-screen flex-col items-center justify-between p-24">
      <Filters_component_1.default />

      <Products_component_1.default />
